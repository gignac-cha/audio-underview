...
/**
 * SVG path icon configuration
 */
interface SVGIconConfiguration extends ProviderDisplayConfigurationBase {
  iconType: 'svg';
  svgPath: string;
  svgViewBox: number;
}
...
export const PROVIDER_DISPLAY_CONFIGURATIONS: Record<OAuthProviderID, ProviderDisplayConfiguration> = {
  ...
  naver: {
    ...
    textColor: '#FFFFFF',
    iconType: 'svg',
    svgPath: 'M16.273 12.845 7.376 0H0v24h7.726V11.156L16.624 24H24V0h-7.727v12.845Z',
    svgViewBox: 24,
  },
};
